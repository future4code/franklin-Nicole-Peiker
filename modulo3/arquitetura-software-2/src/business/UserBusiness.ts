...
import { IDeleteUserInputDTO, IEditUserInputDTO, IGetUserInputDTO, ILoginInputDTO, IMessageOutputDTO, ISignupInputDTO, ITokenOutputDTO, User, USER_ROLES } from "../models/User"
...
export class UserBusiness {
    ...
    public getUsers = async (input: IGetUserInputDTO) => {
        ...
        const payload = this.authenticator.getTokenPayload(token as string)
